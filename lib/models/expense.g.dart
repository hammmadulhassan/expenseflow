...
class Expense extends $Expense with RealmEntity, RealmObjectBase, RealmObject {
  ...
  Expense(
      ...
      DateTime date, {
        ...
        String? exUserId, // New field exUserId
      }) {
    if (!_defaultsSet) {
    ...
    RealmObjectBase.set(this, 'exUserId', exUserId); // Setting exUserId
  }
  ...
  String? get exUserId =>
      RealmObjectBase.get<String>(this, 'exUserId') as String?; // Getter for exUserId
  set exUserId(String? value) => throw RealmUnsupportedSetError(); // Setter for exUserId
  ...
  static SchemaObject _initSchema() {
    ...
    return const SchemaObject(ObjectType.realmObject, Expense, 'Expense', [
      ...
      SchemaProperty('exUserId', RealmPropertyType.string, optional: true), // New schema property for exUserId
    ]);
  }
}
